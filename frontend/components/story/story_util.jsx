...
export const initBlocker = ({ id, user_id, story_id }) => ({
  id: `new_${id || story_id}`,
  story_id,
  user_id: user_id,
  block_reason: '',
...
export const initLink = ({ id, user_id, story_id }) => ({
  id: `new_${id || story_id}`,
  story_id,
  user_id: user_id,
  related_link: '',
...
export const isEmptyBlocker = blocker => blocker.block_reason.trim().length === 0;

export const isEmptyLink = link => link.related_link.trim().length === 0;
